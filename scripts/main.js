...
function displayCourses(filteredCourses) {
    ...
    document.getElementById(
        "totalCredits"
    ).textContent = `The total credits for course listed above is ${total}`;
}
...
document.getElementById("wddBtn").addEventListener("click", () => {
    displayCourses(courses.filter((c) => c.subject.includes("WDD")));
});
document.getElementById("cseBtn").addEventListener("click", () => {
    displayCourses(courses.filter((c) => c.subject.includes("CSE")));
});
